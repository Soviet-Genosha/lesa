<section class="durations mt-4">
    <div class="container">
        <div class="stages-duration mt-3">
            <div class="title text-md-center">
                <h3>Monitor de velocidad</h3>
            </div>
            <div class="subtitle mt-md-4">
                <p>Mide la duración de un juicio hasta llegar al veredicto. Un juicio oral por crímenes de lesa humanidad tarda, en promedio, 2 años y 9 años desde el requerimiento de elevación a juicio hasta el veredicto, según números del Ministerio Público Fiscal. Los juicios orales actualmente abiertos muestran enormes lejanías con ese promedio. </p>
            </div>
